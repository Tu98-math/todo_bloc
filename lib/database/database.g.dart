    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Todo` (`id` TEXT NOT NULL, `desc` TEXT, `completed` INTEGER, PRIMARY KEY (`id`))');
...
class _$TodoDao extends TodoDao {
  ...
  @override
  Future<void> insertTodo(String id, String desc, bool completed) async {
    await _queryAdapter.queryNoReturn(
        'INSERT INTO Todo (id, desc, completed) VALUES (?1, ?2, ?3)',
        arguments: [id, desc, completed ? 1 : 0]);
  }
